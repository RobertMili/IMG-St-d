...
function Footer() {
  ...
  const handleSubmit = (e) => {
    ...
    emailjs.sendForm('service_mgvjz5b', 'template_7vne56v', e.target, 'UvGCnXxRX-3ee22mi')
      .then((result) => {
          ...
          <div className="footer-link-items">
            ...
            <form className="input-group" onSubmit={handleSubmit}>
              ...
              <textarea
                ...
                required
              ></textarea>
              <Button buttonStyle="btn--primary" buttonSize="btn--small" type="submit">
                Submit
              </Button> {/* Ensure Button component renders a native <button> element */}
            </form>
          </div>
        </div>
      </div>
