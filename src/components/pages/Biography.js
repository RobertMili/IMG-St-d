...
export default function Biography() {
  return (
    ...
    textAlignHorizontal="left"
        ...
        <p>
          Carl-Joar Karlsson is a renowned musician, guitarist, and guitar-tech
          known for his exceptional talent and dedication to the art of music.
          Born and raised in a small town, Carl-Joar discovered his passion for
          music at a young age. He began playing the guitar when he was just
          eight years old and quickly developed a deep love for the instrument.
        </p>
        <p>
          ...
          him a loyal following of fans and admirers. Carl-Joar has performed at
          numerous venues and events, captivating audiences with his
          electrifying performances and soulful melodies.
        </p>
        <p>
          In addition to his career as a musician, Carl-Joar is also a skilled
          guitar technician. He has worked with some of the biggest names in the
          music industry, providing expert guitar maintenance and repair
